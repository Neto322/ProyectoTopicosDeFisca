...
using UnityEngine;
using UnityEditor;
using MerryYellow.AutoInputManager.UnityEnchanterEditor;
#if !MY_CE_WINDOW_NAMESPACE_SUPPORT
using MerryYellow.AutoInputManager.UnityEnchanterGUI;
...
namespace MerryYellow.AutoInputManager.UnityEnchanterGUI
{
    ...
    public delegate void MerryYellow_AutoInputManager_UnityEnchanterGUI_ToAdvancedWindowDelegate(EnchanterEditor ee);
    public delegate void MerryYellow_AutoInputManager_UnityEnchanterGUI_SimpleEnchantEventDelegate(EnchanterEditor ee);
#endif // MY_CE_WINDOW_NAMESPACE_SUPPORT

    public class SimpleWindow : EditorWindow
    {
        public bool IsPromotingAutoInputManager =
...
#else // MY_CE_WINDOW_NAMESPACE_SUPPORT
        public event MerryYellow_AutoInputManager_UnityEnchanterGUI_ToAdvancedWindowDelegate ToAdvancedWindowEvent;
        public event MerryYellow_AutoInputManager_UnityEnchanterGUI_SimpleEnchantEventDelegate SimpleEnchantEvent;
#endif // MY_CE_WINDOW_NAMESPACE_SUPPORT
        ...
        EnchanterEditor.States state { get { return enchanterEditor.state; } }
        ...
        void OnGUI()
        {
            ...
            {
                GUILayout.Label("Auto Input Manager is ready.");
        ...
        {
            if (!this.IsPromotingAutoInputManager)
                return;
            ...
            {
                GUILayout.FlexibleSpace();
                //if(GUILayout.Button("Auto Input Manager", s))
                // concat string for avoiding usage of "Auto Input Manager", for not being effected by renaming
